...
Rohr.prototype._set = function (prop, valueFn, last) {
    if (this._matching && !this._matchStatus) {
        return this;
    }
...
Rohr.prototype.set = function (prop, valueFn) {
    if (this._lastPromise) {
        this._lastPromise = this._lastPromise.then(function (self) {
            return self._set(prop, valueFn, true);
        });
...
Rohr.prototype._isBoolean = function () {
    if (this._matching && !this._matchStatus) {
        return this;
    }
...
Rohr.prototype.isBoolean = function () {
    if (this._lastPromise) {
        this._lastPromise = this._lastPromise.then(function (self) {
            return self._isBoolean();
        });
...
Rohr.prototype._rescope = function (path, startAtRoot) {
    if (this._matching && !this._matchStatus) {
        return this;
    }
...
Rohr.prototype.rescope = function (path, startAtRoot) {
    ...
    if (this._lastPromise) {
        this._lastPromise = this._lastPromise.then(function (self) {
            return self._rescope(path, startAtRoot);
        });

        return this;
    }

    return this._rescope(path, startAtRoot);
};
...
Rohr.prototype._validate = function (fn) {
    if (this._matching && !this._matchStatus) {
        return this;
    }
...
Rohr.prototype.validate = function (fn) {
    if (this._lastPromise) {
        this._lastPromise = this._lastPromise.then(function (self) {
            return self._validate(fn);
        });

        return this;
    }

    return this._validate(fn);
};
...
Rohr.prototype._ifEquals = function (arg, last) {
    if (!this._prop) {
...
Rohr.prototype.ifEquals = function (arg) {
    if (this._lastPromise) {
        this._lastPromise = this._lastPromise.then(function (self) {
            return self._ifEquals(arg, true);
        });

        return this;
    }

    return this._ifEquals(arg);
};

Rohr.prototype._endIf = function () {
    if (!this._prop) {
