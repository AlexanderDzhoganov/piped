...
var Rohr = function(object) {
    ...
    this._toPromise = function(ignoreErrors) {
    ...
    this.toPromise = function(ignoreErrors) {
    ...
    this.value = function(valueFn) {
        if(this._lastPromise) {
            this._lastPromise = this._lastPromise.then(function(self) {
                return self._value(valueFn);
            });
    ...
    this._broadcast = function(fields) {
        if(!this._prop) {
            throw 'rescope() called but not inspecting any property';
        }
    ...
    this.broadcast = function(fields) {
        if(this._lastPromise) {
            this._lastPromise = this._lastPromise.then(function(self) {
